...
[![Watch a failed retry become a safe retry](docs/media/duplicate-action-preview.gif)](https://modelfieldnotes.com/agent-explainer/)

**[Open the interactive lab →](https://modelfieldnotes.com/agent-explainer/)** · [Watch the demonstrations](docs/launch/educator-walkthrough.md) · [Contribute an experiment](CONTRIBUTING.md)
...
| ---------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | -------------------------------------------------- |
| [The duplicate action](https://modelfieldnotes.com/agent-explainer/#/experiment/duplicate-action/1/baseline/0)           | A tool commits a ticket, its response disappears, and a retry creates another.    | Reuse an idempotency key.                          |
| [The forgotten instruction](https://modelfieldnotes.com/agent-explainer/#/experiment/forgotten-instruction/1/baseline/0) | Compaction drops “draft only” and the simulated agent publishes.                  | Retain constraints outside the compressed history. |
| [The premature “done”](https://modelfieldnotes.com/agent-explainer/#/experiment/premature-done/1/baseline/0)             | A tool accepts a job and the agent announces completion before the report exists. | Verify the authoritative result.                   |
